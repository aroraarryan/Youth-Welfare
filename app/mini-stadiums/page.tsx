    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto my-10 px-5">
        ...
        <div className="bg-white rounded-xl p-8 shadow-[0_4px_15px_rgba(0,0,0,0.05)] mb-8 flex flex-col items-center gap-5">
          <h3 className="text-2xl text-[#2c3e50] font-semibold">Find Mini Stadiums by District</h3>
        ...
        <div className="min-h-[300px]">
            ...
            <>
              <div className="mb-5 pb-2 border-b-[3px] border-[#1e3a8a] inline-block">
                <h2 className="text-[2rem] text-[#2c3e50] capitalize">
                  {selectedDistrict?.name} — Mini Stadiums
                </h2>
              </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-20">
                  ...
                  <p className="text-[#9ca3af] text-lg">No mini stadiums found for {selectedDistrict?.name} yet.</p>
                </div>
              ) : (
          ...
          {!selectedDistrictId && (
            <div className="text-center py-20">
              ...
              <p className="text-[#9ca3af] text-lg">Select a district to view Mini Stadiums</p>
            </div>
          )}
        </div>
      </div>
